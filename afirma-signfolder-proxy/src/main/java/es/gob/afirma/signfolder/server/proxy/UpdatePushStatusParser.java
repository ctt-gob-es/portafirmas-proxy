...
/**
 * Clase que analiza la estructura del servicio de actualización del estado de las notificaciones push.
 */
public class UpdatePushStatusParser {
	 ...
	 */
	private static final String REQUEST_NODE = "pdtpshsttsrq";
