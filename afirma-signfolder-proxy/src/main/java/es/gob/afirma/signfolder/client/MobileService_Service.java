 ...
 * 
 */
@WebServiceClient(name = "MobileService", targetNamespace = "urn:juntadeandalucia:cice:pfirma:mobile:v2.0", wsdlLocation = "https://des-portafirmasage.redsara.es/pf/servicesv2/MobileService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://des-portafirmasage.redsara.es/pf/servicesv2/MobileService?wsdl");
